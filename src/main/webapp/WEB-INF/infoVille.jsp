...
<%@ include file="menu.jsp" %>
    ...
    <form method="post" action="villes?page=infoVille&code_commune=${ville.getCode_commune_INSEE()}">
    	...
    	<input type="text" id="code_commune" name="code_commune" value="${ville.getCode_commune_INSEE()}">
	...
	<br>
	<button onclick="window.location.href = 'http://localhost:8080/TP_ESEO_API_Rest_Client/villes?page=villes';">Retour</button>
